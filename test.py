...
# simcloud job post --cpus 8 --gpus 2 --memory 128 --timeout 5m --attributes gpu_brand:Tesla --smi current-ubuntu18.04-cuda11.0 --bundle bundle-96092e4fe8b3414aa9a9db60f9bcc86e --command "python3 /Users/zhenyu/Documents/Scripts/IphoneAOI/yolov5/test.py" --output archive.zip
...
print('*'*20, 'starting to python3', '*'*20)
