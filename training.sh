...
python3 -m torch.distributed.launch --nproc_per_node 4 train.py --batch 16 --data iphoneaoi.yaml --weights yolov5x.pt --device 0,1,2,3 --epochs 600 --img 1280 --adam --cache
